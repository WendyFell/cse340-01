...
-- code from creating the table in pg admin using the CREATE table GUI
...
-- The two statements below were generated by pg admin when making the table. I don't know if we really need these...
